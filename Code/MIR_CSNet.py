...
class MIR_CSNet(nn.Module):
    def __init__(self):
        super(MIR_CSNet, self).__init__()
        ...
        self.dbconv5_1 = DoubleConv3(64, 512)
        self.dbconv5_2 = DoubleConv3(1024, 512)
        self.dbconv5_3 = DoubleConv3(448, 512)
        self.dbconv6_1 = DoubleConv3(32, 256)
        self.dbconv6_2 = DoubleConv3(512, 256)
        self.dbconv6_3 = DoubleConv3(224, 256)
        self.dbconv7_1 = DoubleConv3(16, 128)
        self.dbconv7_2 = DoubleConv3(256, 128)
        self.dbconv7_3 = DoubleConv3(112, 128)
        self.dbconv8_1 = DoubleConv3(8, 64)
        self.dbconv8_2 = DoubleConv3(128, 64)
        self.dbconv8_3 = DoubleConv3(56, 64)
        ...
        self.netBlock_1 = SSOC(64, 64)
        self.netBlock_2 = SSOC(128, 128)
        self.netBlock_3 = SSOC(256, 256)
    ...
    def forward(self, x):
        ...
        x_addition1 = torch.ones_like(x_1)
        x_1 = x_addition1 - x_1
        x_1 = self.dbconv5_1(x_1)
        x_2 = self.dbconv5_3(x_2)
        x = x_1 + x_2
        ...
        x = F.interpolate(x, scale_factor=2, mode='bilinear', align_corners=True)
        x = self.dwconv6(x)
        x_1, x_2 = torch.split(x, [32, 224], dim=1)
        x_addition2 = torch.ones_like(x_1)
        x_1 = x_addition2 - x_1
        x_1 = self.dbconv6_1(x_1)
        x_2 = self.dbconv6_3(x_2)
        x = x_1 + x_2
        ...
        x = F.interpolate(x, scale_factor=2, mode='bilinear', align_corners=True)
        x = self.dwconv7(x)
        x_1, x_2 = torch.split(x, [16, 112], dim=1)
        x_addition3 = torch.ones_like(x_1)
        x_1 = x_addition3 - x_1
        x_1 = self.dbconv7_1(x_1)
        x_2 = self.dbconv7_3(x_2)
        x = x_1 + x_2
        ...
        x = F.interpolate(x, scale_factor=2, mode='bilinear', align_corners=True)
        x = self.dwconv8(x)
        x_1, x_2 = torch.split(x, [8, 56], dim=1)
        x_addition4 = torch.ones_like(x_1)
        x_1 = x_addition4 - x_1
        x_1 = self.dbconv8_1(x_1)
        x_2 = self.dbconv8_3(x_2)
        x = x_1 + x_2
